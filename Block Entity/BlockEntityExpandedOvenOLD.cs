...
{
    //Obsolete old implementation of a custom ExpandedOven BlockEntity class, made defunct by the new version. Left for posterity for the time being - Pursec(Goose)
    public class BlockEntityExpandedOvenOLD : BlockEntityDisplay, IHeatSource, ITexPositionSource
    {
        ...
        public BlockEntityExpandedOvenOLD()
        {
