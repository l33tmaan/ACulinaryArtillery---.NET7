 ...
 /*       public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            if (content != null)
            {
				...
				/////////////////////////////////////////////////////////////////////////////////////////
				//Finally, add that extra shit that l33t wants
				//
				//
				EntityPlayer entity = world.Side == EnumAppSide.Client ? (world as IClientWorldAccessor).Player.Entity : null;
				float spoilState = AppendPerishableInfoText(dummy, new StringBuilder(), world);

				FoodNutritionProperties nutriProps = GetNutritionProperties(world, dummy.Itemstack, entity);
				FoodNutritionProperties[] addProps = GetPropsFromArray((dummy.Itemstack.Attributes["expandedSats"] as FloatArrayAttribute)?.value);
